        ...
        <div>
            ...
            <div class="row">
                <ul class="list-group w-100 h-100">
                    <Link to='/message/1' class="list-group-item list-group-item-action d-flex justify-content-between align-items-center" >Poruka 1&nbsp; - Dinamicki deo opisa - highliter - ako je aktivirana pretraga <span class="badge badge-primary badge-pill">14</span></Link>
