        ...
        <div>
            ...
            <div className="row">
                <ul className="list-group w-100 h-100">
                    <Link to='/message/1' className="list-group-item list-group-item-action d-flex justify-content-between align-items-center" >Poruka 1&nbsp; - Dinamicki deo opisa - highliter - ako je aktivirana pretraga <span className="badge badge-primary badge-pill">14</span></Link>
